...
workflow PREPARE_MULTIQC_DATA {
    ...
    ch_fastq_stats_file = ch_fastq_stats
                            .collectFile(
    ...
    ch_nb_species_per_family_file = ch_species_taxids
    ...
    ch_nb_srrs_per_family_file = ch_reads_fasta
    ...
    ch_dl_genome_len = channel.topic('dl_genome_metadata')
    ...
    ch_read_fasta_size_file = ch_reads_fasta
    ...
    ch_downloaded_genome_size_file = channel.topic('dl_genome_metadata') // family, taxid, genome_file, nb_bases
                                        .collectFile(
    ...
    ch_assembled_genome_size_file = channel.topic('asm_genome_len') // family, id, nb_bases
                                        .collectFile(
    ...
    ch_blast_nb_hits = channel.topic('blast_nb_hits')
                        .branch {
    ...
    ch_blast_nb_hits_target_file = ch_blast_nb_hits.target // family, id, nb_hits
                                        .collectFile(
    ...
    ch_blast_nb_hits_genomes_file = ch_blast_nb_hits.genomes // family, id, nb_hits
                                        .collectFile(
    ...
    ch_data_per_family = ch_data_per_family
